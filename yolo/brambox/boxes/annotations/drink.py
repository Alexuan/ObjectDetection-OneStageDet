...
__all__ = ['DrinkAnnotation', 'DrinkParser']


class DrinkAnnotation(Annotation):
    ...
    def deserialize(self, xml_obj):
        ...
        self.occluded = False
        # self.difficult = xml_obj.find("attributes").find('difficult0').text == '1'
